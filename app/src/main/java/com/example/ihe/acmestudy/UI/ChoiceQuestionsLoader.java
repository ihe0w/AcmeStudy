...
public class ChoiceQuestionsLoader extends RecyclerView.Adapter<ChoiceQuestionsLoader.QuestionHolder> {
    ...
    ChoiceQuestionsLoader(int type, List<String> optionContentList, RecyclerView recyclerView) {
        Log.d("#", "QL start");
        this.type = type;
    ...
    public void onBindViewHolder(@NonNull QuestionHolder holder, int position) {
        if (type==QuestionForDBAgent.GAP_FILLING){
